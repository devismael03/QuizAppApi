...
namespace QuizAPI.Migrations
{
    ...
    [Migration("20221205152755_Initial")]
            ...
            modelBuilder.Entity("QuizAPI.Models.Take", b =>
                {
                    ...
                    b.HasIndex("TakerId")
                        .HasDatabaseName("ix_take_taker_id");

                    b.HasIndex("TestId")
                        .HasDatabaseName("ix_take_test_id");

                    b.ToTable("take", (string)null);
                });
            ...
            modelBuilder.Entity("QuizAPI.Models.TakeAnswer", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_take_answer");

                    b.HasIndex("OptionId")
                        .HasDatabaseName("ix_take_answer_option_id");

                    b.HasIndex("TakeQuestionId")
                        .HasDatabaseName("ix_take_answer_take_question_id");

                    b.ToTable("take_answer", (string)null);
                });
            ...
            modelBuilder.Entity("QuizAPI.Models.Test", b =>
                {
                    ...
                    b.HasIndex("QuizId")
                        .HasDatabaseName("ix_test_quiz_id");
            ...
            modelBuilder.Entity("QuizAPI.Models.Quiz", b =>
                {
                    b.HasOne("QuizAPI.Authentication.ApplicationUser", "Author")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_quiz_users_author_id");
            ...
            modelBuilder.Entity("QuizAPI.Models.Take", b =>
                {
                    b.HasOne("QuizAPI.Authentication.ApplicationUser", "Taker")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_take_users_taker_id");
                    ...
                    b.HasOne("QuizAPI.Models.Test", "Test")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_take_test_test_id");
            ...
            modelBuilder.Entity("QuizAPI.Models.TakeAnswer", b =>
                {
                    b.HasOne("QuizAPI.Models.Option", "Option")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_take_answer_option_option_id");
                    ...
                    b.HasOne("QuizAPI.Models.TakeQuestion", "TakeQuestion")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_take_answer_take_question_take_question_id");
            ...
            modelBuilder.Entity("QuizAPI.Models.TakeQuestion", b =>
                {
                    b.HasOne("QuizAPI.Models.Question", "Question")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_take_question_question_question_id");
                    ...
                    b.HasOne("QuizAPI.Models.Take", "Take")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_take_question_take_take_id");
            ...
            modelBuilder.Entity("QuizAPI.Models.Test", b =>
                {
                    b.HasOne("QuizAPI.Models.Quiz", "Quiz")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_test_quiz_quiz_id");
